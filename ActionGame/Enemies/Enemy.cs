...
public abstract partial class Enemy : CharacterBody2D
{
    ...
    protected void ResolveMovement()
    {
        ...
        if (collision != null)
        {
            ...
            {
                player.TakeDamage(DAMAGE_CONTACT + GlobalVariables.Enemy.ENEMY_BONUS_DAMAGE, DAMAGETYPE);
            }
        }
    }
    ...
    protected void SpawnBullet(Vector2 direction)
    {
        ...
        newBullet.Initialize(Room, velocity, DAMAGETYPE, DAMAGE_BULLET + GlobalVariables.Enemy.ENEMY_BONUS_DAMAGE, Team.ENEMY);
